...
def test_daily_event_returns_200_with_command_id(mock_ssm):
    ...
    _set_env()
    mock_ssm.send_command.return_value = {"Command": {"CommandId": "cmd-daily-001"}}
...
def test_weekly_event_returns_200_with_command_id(mock_ssm):
    ...
    _set_env()
    mock_ssm.send_command.return_value = {"Command": {"CommandId": "cmd-weekly-001"}}
...
def test_ssm_exception_propagates(mock_ssm):
    ...
    _set_env()
    mock_ssm.send_command.side_effect = Exception("SSM service unavailable")
